    ...
    if (isLoading) {
      fetchUserData().then(datanew => {
        if (datanew === null || undefined) {
          ...
          id = datanew.reg_no
          dept = datanew.dept
          if(dept === "dev" && datanew.role === "admin"){
            console.log("admin of dev")
          }
          else if(dept === "dev" && datanew.role === "core"){
            console.log("core of dev")
          }
          else if(datanew.role === "core"){
            console.log("core of non dev")
          }
          else if(dept === "dev" && datanew.role === "user"){
